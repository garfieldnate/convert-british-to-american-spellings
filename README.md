...
This outputs `.json` files in the `lib/Words/AmericanBritish/` directory. In addition, basic sanity checks for ambiguous mappings are executed and warnings are printed; the data is not automatically fixed, and all warnings must be fixed manually.
